...
async function mostrarPortadas(generoSeleccionado) {
    ...
    for (const libro of libros) {
        console.log(`Título: ${libro.Titulo}, Autor: ${libro.Autor}, Género: ${libro.Genero}, Portada: ${libro.Portada}`);
        ...
        portada.innerHTML = `
            <article class="increment">
                ...
                <p style="margin-top: 15px; flex-grow: 1;">Breve descripción del contenido del libro...</p>
